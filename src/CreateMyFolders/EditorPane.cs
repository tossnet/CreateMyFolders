...
namespace EBLM.CreateMyFolders
{
    ...
    //     - An empty createmyfolders file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.createmyfolders. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.createmyfolders, MyExtFile2.createmyfolders... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.createmyfolders|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.createmyfolders - our empty createmyfolders file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".createmyfolders";
        ...
        #region Fields
        private CreateMyFoldersPackage myPackage;
        ...
        public EditorPane(CreateMyFoldersPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the createmyfolders document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(CreateMyFoldersPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidCreateMyFoldersCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidCreateMyFoldersCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidCreateMyFoldersEditorFactory;
            return VSConstants.S_OK;
        }
