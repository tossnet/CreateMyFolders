...
namespace EBLM.CreateMyFolders
{
    ...
    /// </summary>
    [Guid(GuidList.guidCreateMyFoldersEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private CreateMyFoldersPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(CreateMyFoldersPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidCreateMyFoldersEditorFactory;
            pgrfCDW = 0;
